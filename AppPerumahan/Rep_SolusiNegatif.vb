...
Public Class Rep_SolusiNegatif
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPerumahan.Rep_SolusiNegatif.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_SolusiNegatif
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_SolusiNegatif = New Rep_SolusiNegatif
        rpt.Site = Me.Site
        Return rpt
    End Function
