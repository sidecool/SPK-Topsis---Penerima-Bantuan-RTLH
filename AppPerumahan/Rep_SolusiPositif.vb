...
Public Class Rep_SolusiPositif
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPerumahan.Rep_SolusiPositif.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_SolusiPositif
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_SolusiPositif = New Rep_SolusiPositif
        rpt.Site = Me.Site
        Return rpt
    End Function
